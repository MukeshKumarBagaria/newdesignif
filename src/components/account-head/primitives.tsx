...
/* ───────── StatusSwitch ─────────
 * Active / Inactive iOS-style switch with embedded label.
 */
...
export function StatusSwitch({
  ...
  return (
    <button
      ...
      className="inline-flex items-center font-poppins transition-colors focus:outline-none"
      style={{
        height: FIELD_HEIGHT,
        padding: '4px 6px 4px 6px',
        gap: 10,
        borderRadius: 999,
        border: `1px solid ${active ? '#358217' : '#5A72A5'}`,
        background: active ? '#E6F5E1' : '#F6F7F8',
      }}
    >
      <motion.span
        layout
        ...
        style={{
          ...
          height: 20,
          borderRadius: 999,
          background: active ? '#358217' : '#BFBFBF',
        }}
      >
        <motion.span
          layout
          transition={{ type: 'spring', stiffness: 500, damping: 32 }}
          className="absolute top-0.5 bg-white"
          style={{
            width: 16,
            height: 16,
            borderRadius: 999,
